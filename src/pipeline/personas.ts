...
export const SECURITY_AUDITOR: PersonaConfig = {
...
export const RUST_SPECIALIST: PersonaConfig = {
...
export function detectPrimaryLanguage(files: DiffFile[]): Language {
...
export function getSpecialist(language: Language): PersonaConfig {
  switch (language) {
 ...
 */
export function selectPersonas(files: DiffFile[]): PersonaConfig[] {
